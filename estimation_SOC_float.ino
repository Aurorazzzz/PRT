...
const float ECART_TYPE[tailleEntree] = {2.8921 , 4.4502 , 5.0943 };
  ...
  // simulation
  // Mesure du temps de simulation, a régler plus tard
  // tempsInitial = micros();
